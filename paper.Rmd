...
abstract: "Comprender el desarrollo del comportamiento político juvenil y las desigualdades asociadas a este sigue siendo un desafío para las ciencias sociales, particularmente en tiempos en que los jóvenes han tomado mayor protagonismo en la esfera pública. Usando datos del Panel de Ciudadanía Escolar (ola 1) en que participaron 1635 estudiantes de 2° medio y 744 de sus apoderados durante el año 2019, se provee evidencia acerca del rol que juegan los recursos de la familia (educación, ingreso y libros) para explicar la participación política de los jóvenes. Asímismo, se provee evidencia acerca del grado de consistencia en el comportamiento político entre padres/madres y sus hijos/hijas, como proceso de socialización. Finalmente, se muestra el rol que juegan características de la escuela, como el desarrollo de actividades de socialización política y el clima abierto a la discusión, en la participación política de jóvenes secundarios"
link-citations: yes
linkcolor: blue
editor_options:
...
Cuando el interés por la participación política se reproduce dentro del contexto familiar los académicos del área hablan de transmisión intergeneracional de la participación política, que se define como la herencia del interés por la participación política y de sus preferencias desde los apoderados hacia jóvenes de nuevas generaciones. Así, en la sociología y la ciencia política se ha indicado que la transmisión intergeneracional es un fenómeno que reproduce desigualdad entre jóvenes de distintos grupos sociales, esto puesto que se ha demostrado que familias con mayores niveles de politización o con mayores recursos económicos y culturales traspasan en mayor medida sus prácticas políticas a sus descendencias, en desmedro de jóvenes con familias menos comprometidas políticamente o con menores recursos.

A su vez, en las ciencias sociales se ha investigado el papel que juega la escuela moderando esta desigualdad de origen. Particularmente se ha estudiado el efecto moderador que tiene la socialización política escolar sobre las desigualdades familiares de origen respecto a la participación políica. En esa línea, se ha demostrado que en aquellas escuelas con mayores actividades de participación o con mayores niveles de apertura a la discusión, las desigualdades que produce la socialización política familiar se mitigan.
...
a) ¿En qué medida las prácticas políticas parentales, los recursos socioeconómicos de la familia y la socialización política escolar inciden en la participación política de los jóvenes?
...
Para efectos de este estudio, se distinguieron dos tipos de socialización política familiar: la socialización política familiar directa (SPFD) y la socialización política familiar indirecta (SPFI). Por una parte, la socialización política familiar directa se presenta cuando las familias de los jóvenes están comprometidas políticamente. Particularmente sucede cuando los niños crecen en un ambiente familiar políticamente activo, lo que lleva a jóvenes a participar en actividades políticas desde pequeños y desarrollar habilidades políticas tempranamente [@mcfarlandBowling2006; @quintelierEngaging2015]. Investigadores que han utilizado el concepto indican que el tener familiares involucrados en política con conlleva a desarrollar mayores niveles de participación política en el futuro [@quintelierEngaging2015].

Por otra parte, la socialización política familiar indirecta ocurre cuando en un contexto de familia se discute y dialoga con frecuencia sobre temas relacionados con la política y la actualidad, lo que facilita una transmisión intergeneracional del lenguaje político, preferencias y el interés por la política. En investigaciones relacionadas se ha encontrado que la conversación intergeneracional sobre asuntos públicos puede tener una influencia positiva en el compromiso cívico, el conocimiento político y la participación de los jóvenes [@hoskinsEducation2019; @mcintoshInfluence2007]. Así, también se ha demostrado en algunas investigaciones que en familias donde más se conversa sobre política, mayor predisposición hay para inscribirse en registros electorales y participar en los asuntos públicos de un país, caso contrario en aquellas familias en que menos se dialoga sobre estas temáticas [@mcintoshInfluence2007; @quintelierEngaging2015].

## Modelo de recursos culturales

Las herramientas que entregan las familias para la interpretación y análisis del mundo social y político están, a su vez, influenciadas por los recursos socioeconómicos y culturales con los cuales cuentan dichos núcleos. La literatura especializada hace hincapié particularmente en aquellas características que presentan los hogares en los que viven los niños y jóvenes respecto a los procesos, contenidos y dinámicas vinculadas a la socialización y participación política [@hoskinsEducation2019; @naterasInformacion2007]. Diversos autores han probado que existe una relación muy marcada entre los recursos culturales y educacionales familiares y la transmisión intergeneracional del compromiso político de los jóvenes, en tanto las dinámicas en los que se encuentran inmersos son producto de “complejos mecanismos de influencia y construcción sociales, concretados a través de mediadores o agentes socializantes” [@naterasInformacion2007, pág. 1360]
...
La participación política suscitada por el espacio escolar provee de herramientas políticas a los jóvenes, ya que el primer tipo de educación ciudadana es la educación cívica [@quintelierEngaging2015]. No obstante, “las experiencias escolares parecieran adquirir un sentido diferente de acuerdo con el tipo de institución de la que se trate” [@nunezDEMANDAS2021], incidiendo en el ejercicio político. Es a través de la interacción dentro de espacios socializadores comunitarios donde se reafirman, potencian o nivelan los compromisos políticos de los jóvenes. Rodríguez Bustamante declara que existe una influencia positiva de la escuela en dicha relación, ya que la implementación de instancias democratizantes simuladas, como la elección de representantes estudiantiles, resultan fundamentales para el aprendizaje político y ciudadano de los sujetos [@rodriguezbustamanteParticipacion2020].
...
<<<<<<< HEAD
Para efectos del análisis se observarán las regresiones multinivel con el objetivo de conocer en que qué grado las prácticas de socialización política familiar (H1), los recursos familiares (H2a y H2b) y la socialización política escolar (H3) explican la participación política juvenil formal, activista disruptiva y activista no disruptiva. Posteriormente, se realizó un test ANOVA con el objetivo de liberar pendientes de las variables de nivel uno y saber si son aleatorias respecto a las escuelas, esto con el objetivo de conocer los efectos de moderación que la escuela tiene en la asociación entre los recursos y socialización política parental sobre de las desigualdades de origen en la participación política de los jóvenes chilenos (H4 y H5).

Por último, cabe señalar que esta investigación fue prerregistrada de manera pública en la plataforma OSF [^1].
=======
Para efectos del análisis se observarán las regresiones de mínimos cuadrados ordinarios (OLS, por su sigla en inglés) con el objetivo de conocer en que qué grado las prácticas de socialización política familiar (H1), los recursos familiares (H2a y H2b) y la socialización política escolar (H3) explican la participación política juvenil formal, activista disruptiva y activista no disruptiva. Posteriormente, se realizó un test ANOVA con el objetivo de liberar pendientes de las variables de nivel uno y saber si son aleatorias respecto a las escuelas, esto con el objetivo de conocer los efectos de moderación que la escuela tiene en la asociación entre los recursos y socialización política parental sobre de las desigualdades de origen en la participación política de los jóvenes chilenos (H4 y H5). Por último, cabe señalar que esta investigación fue prerregistrada de manera pública en la plataforma OSF [^1].
>>>>>>> bcdca0893ee2635a885f5196e279b43638deb911
