...
En esa línea, estudios en Chile reportan resultados similares, y es que un ambiente donde se propicie la discusión, el debate, la exposición de ideologías, entre otras formas de participación, mitigan las diferencias socioeconómicas de origen [@ascorraParticipacion2016]; [@castilloMitigating2014; @castilloSocial2014]. En tanto se trata de formas de participación, este punto incide sin lugar a dudas en los sentidos asociados al ejercicio de derechos y la ciudadanía. Se ha demostrado que los estudiantes de escuelas carentes de instancias de simulación democrática o deliberación comunitarias ven mermadas las posibilidades de plantear demandas y exigencias comunes, proyectándose en la participación política a futuro (Ascorra, 2016; [@quintelierEngaging2015].  
